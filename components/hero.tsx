  ...
  return (
    <div ref={containerRef} className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl font-medium mb-8">Data Analyst & Data Science Engineer</h2>
        <p className="text-lg mb-8 max-w-2xl mx-auto">
          Turning data into actionable insights and building intelligent solutions
        </p>
